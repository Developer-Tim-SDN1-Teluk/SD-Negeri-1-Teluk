            ...
            <div class="logo">
                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li>
                            <div class="dropdown">
                                <a class="active dropbtn">Galeri</a>
                                <div class="dropdown-content">
                        ...
                        <div class="row justify-content-center md-center">
                            <div class="col-lg-7 video-box">
                                <div class="text-center">
                                    <div><iframe width="700" height="500" src="https://www.youtube.com/embed/k17_6oomerU" title="YouTube video player" 
                                        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <br>
                                    <div><iframe width="700" height="500" src="https://www.youtube.com/embed/90yNRhgmU7o" title="YouTube video player"
                                        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <br>
                                    <div><iframe width="700" height="500" src="https://www.youtube.com/embed/8HvmyctuGRM" title="YouTube video player" 
                                        frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
